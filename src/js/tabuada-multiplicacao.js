...
console.log(`${fatorMultiplicador} * ${indice} = ${fatorMultiplicador * indice}`); //0
indice++;
totalGeral += fatorMultiplicador * indice;
console.log(`${fatorMultiplicador} * ${indice} = ${fatorMultiplicador * indice}`); //1
indice++;
totalGeral += fatorMultiplicador * indice;
console.log(`${fatorMultiplicador} * ${indice} = ${fatorMultiplicador * indice}`); //2
indice++;
totalGeral += fatorMultiplicador * indice;
console.log(`${fatorMultiplicador} * ${indice} = ${fatorMultiplicador * indice}`); //3
indice++;
totalGeral += fatorMultiplicador * indice;
...
console.log(`Soma total: ${totalGeral}`);